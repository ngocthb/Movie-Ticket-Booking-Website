    ...
    <section className="h-dvh w-dvw max-h-[80rem] relative">
      <div className="absolute inset-0 z-[1]">
        <img
          ...
          src="https://i.pinimg.com/736x/a8/48/51/a84851ac8d30dc51f7f18bb75186127f.jpg"
          alt=""
        />
      </div>
        ...
        <div className="h-full w-full  flex flex-col relative space-y-6">
          <div className="mt-auto mb-0 text-gray-50 md:pb-36 space-y-6">
            ...
            <div className="md:flex-row flex-col flex gap-4">
              ...
              <button className="inline-block text-base font-medium px-12 py-2 border border-accent-400 rounded-lg text-accent-400 cursor-pointer bg-gray-50/10 backdrop-blur-3xl hover:bg-gray-50/20">
                Booking Now
              </button>
            </div>
          </div>
